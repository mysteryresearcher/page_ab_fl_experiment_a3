...
# Form implementation generated from reading ui file './../forms/./../forms/SimulationWidget.ui'
#
...
class Ui_SimulationWidget(object):
    def setupUi(self, SimulationWidget):
        ...
        SimulationWidget.setTabOrder(self.edtFieldsThatContains, self.tblSummary)
        SimulationWidget.setTabOrder(self.tblSummary, self.tblExperiments)
        SimulationWidget.setTabOrder(self.tblExperiments, self.btnStart)
        SimulationWidget.setTabOrder(self.btnStart, self.btnRefreshInformationAboutExp)
        SimulationWidget.setTabOrder(self.btnRefreshInformationAboutExp, self.btnCancelAll)
        SimulationWidget.setTabOrder(self.btnCancelAll, self.btnCancel)
        SimulationWidget.setTabOrder(self.btnCancel, self.btnRemoveExperiments)
        SimulationWidget.setTabOrder(self.btnRemoveExperiments, self.btnRemoveSelectedExperiments)
        SimulationWidget.setTabOrder(self.btnRemoveSelectedExperiments, self.btnClean)
