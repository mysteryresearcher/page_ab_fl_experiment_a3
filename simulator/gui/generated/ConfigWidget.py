...
# Form implementation generated from reading ui file './../forms/./../forms/ConfigWidget.ui'
#
...
class Ui_ConfigWidget(object):
    def setupUi(self, ConfigWidget):
        ...
        self.tabExeprimentConfig.setGeometry(QtCore.QRect(0, 0, 1031, 1003))
        ...
        self.edtClientCompressorConfig.setText("")
        ...
        self.lblHomogeneousDS_L1 = QtWidgets.QLabel(self.frameExperimentConfig)
        self.lblHomogeneousDS_L1.setObjectName("lblHomogeneousDS_L1")
        self.formLayout.setWidget(34, QtWidgets.QFormLayout.LabelRole, self.lblHomogeneousDS_L1)
        ...
        self.formLayout.setWidget(37, QtWidgets.QFormLayout.LabelRole, self.lblNumberOfClients)
        ...
        self.formLayout.setWidget(37, QtWidgets.QFormLayout.FieldRole, self.edtNumberOfClients)
        self.lblGlobalModel = QtWidgets.QLabel(self.frameExperimentConfig)
        self.lblGlobalModel.setObjectName("lblGlobalModel")
        self.formLayout.setWidget(38, QtWidgets.QFormLayout.LabelRole, self.lblGlobalModel)
        ...
        self.cbxGlobalModel.addItem("")
        self.cbxGlobalModel.addItem("")
        self.formLayout.setWidget(38, QtWidgets.QFormLayout.FieldRole, self.cbxGlobalModel)
        ...
        self.formLayout.setWidget(39, QtWidgets.QFormLayout.LabelRole, self.lblLossFunctionForGlobalModel)
        ...
        self.cbxLossFunctionForGlobalModel.addItem("")
        self.cbxLossFunctionForGlobalModel.addItem("")
        self.formLayout.setWidget(39, QtWidgets.QFormLayout.FieldRole, self.cbxLossFunctionForGlobalModel)
        ...
        self.formLayout.setWidget(41, QtWidgets.QFormLayout.LabelRole, self.lblExtraRegulizer)
        ...
        self.formLayout.setLayout(41, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_5)
        ...
        self.formLayout.setWidget(44, QtWidgets.QFormLayout.LabelRole, self.lblValidationOptMetric)
        ...
        self.cbxValidationOptMetric.addItem("")
        self.cbxValidationOptMetric.addItem("")
        self.formLayout.setWidget(44, QtWidgets.QFormLayout.FieldRole, self.cbxValidationOptMetric)
        ...
        self.formLayout.setWidget(45, QtWidgets.QFormLayout.LabelRole, self.lblValidationAssementFreq)
        ...
        self.formLayout.setWidget(45, QtWidgets.QFormLayout.FieldRole, self.edtValidationAssementFreq)
        ...
        self.formLayout.setWidget(46, QtWidgets.QFormLayout.LabelRole, self.lblTrackQuantities)
        ...
        self.formLayout.setWidget(46, QtWidgets.QFormLayout.FieldRole, self.widget_2)
        self.spbHomogeneousDS_L1 = QtWidgets.QDoubleSpinBox(self.frameExperimentConfig)
        self.spbHomogeneousDS_L1.setDecimals(6)
        self.spbHomogeneousDS_L1.setMaximum(1000000.0)
        self.spbHomogeneousDS_L1.setSingleStep(0.01)
        self.spbHomogeneousDS_L1.setProperty("value", 0.6)
        self.spbHomogeneousDS_L1.setObjectName("spbHomogeneousDS_L1")
        self.formLayout.setWidget(34, QtWidgets.QFormLayout.FieldRole, self.spbHomogeneousDS_L1)
        self.lblHomogeneousDS_L2 = QtWidgets.QLabel(self.frameExperimentConfig)
        self.lblHomogeneousDS_L2.setObjectName("lblHomogeneousDS_L2")
        self.formLayout.setWidget(35, QtWidgets.QFormLayout.LabelRole, self.lblHomogeneousDS_L2)
        self.spbHomogeneousDS_L2 = QtWidgets.QDoubleSpinBox(self.frameExperimentConfig)
        self.spbHomogeneousDS_L2.setDecimals(6)
        self.spbHomogeneousDS_L2.setMaximum(1000000.0)
        self.spbHomogeneousDS_L2.setSingleStep(0.5)
        self.spbHomogeneousDS_L2.setProperty("value", 0.01)
        self.spbHomogeneousDS_L2.setObjectName("spbHomogeneousDS_L2")
        self.formLayout.setWidget(35, QtWidgets.QFormLayout.FieldRole, self.spbHomogeneousDS_L2)
        self.lblSolutionPerturbation = QtWidgets.QLabel(self.frameExperimentConfig)
        self.lblSolutionPerturbation.setObjectName("lblSolutionPerturbation")
        self.formLayout.setWidget(36, QtWidgets.QFormLayout.LabelRole, self.lblSolutionPerturbation)
        self.edtSolPerturbation = QtWidgets.QLineEdit(self.frameExperimentConfig)
        self.edtSolPerturbation.setObjectName("edtSolPerturbation")
        self.formLayout.setWidget(36, QtWidgets.QFormLayout.FieldRole, self.edtSolPerturbation)
        ...
        self.tabSystemAspects.setGeometry(QtCore.QRect(0, 0, 1045, 802))
        ...
        self.cbxGenerateRunSeedAuto.setChecked(True)
        ...
        self.formLayout_4.setWidget(20, QtWidgets.QFormLayout.FieldRole, self.loComputeDevicesWidget)
        ...
        self.formLayout_4.setLayout(21, QtWidgets.QFormLayout.FieldRole, self.loSelectAllGpus)
        ...
        self.formLayout_4.setWidget(22, QtWidgets.QFormLayout.LabelRole, self.lblLoggingLevel)
        ...
        self.formLayout_4.setWidget(29, QtWidgets.QFormLayout.LabelRole, self.lblSerializingThreadPool)
        ...
        self.formLayout_4.setWidget(29, QtWidgets.QFormLayout.FieldRole, self.edtSerializingThreadPool)
        ...
        self.formLayout_4.setWidget(30, QtWidgets.QFormLayout.LabelRole, self.lblLocalTrainingThreadPool)
        ...
        self.formLayout_4.setWidget(30, QtWidgets.QFormLayout.FieldRole, self.edtLocalTraininThreadPool)
        ...
        self.formLayout_4.setWidget(33, QtWidgets.QFormLayout.LabelRole, self.lblDataLoadBatchSize)
        ...
        self.formLayout_4.setWidget(33, QtWidgets.QFormLayout.FieldRole, self.edtDataLoadBatchSize)
        ...
        self.formLayout_4.setWidget(34, QtWidgets.QFormLayout.LabelRole, self.lblStoreClientStateInCPU)
        ...
        self.formLayout_4.setWidget(34, QtWidgets.QFormLayout.FieldRole, self.cbxStoreClientStateInCPU)
        ...
        self.formLayout_4.setWidget(35, QtWidgets.QFormLayout.LabelRole, self.lblEmptyGPUTorchCache)
        ...
        self.formLayout_4.setWidget(35, QtWidgets.QFormLayout.FieldRole, self.cbxEmptyGPUTorchCache)
        self.lblWandbKey = QtWidgets.QLabel(self.frameSystemConfig)
        self.lblWandbKey.setObjectName("lblWandbKey")
        self.formLayout_4.setWidget(38, QtWidgets.QFormLayout.LabelRole, self.lblWandbKey)
        ...
        self.formLayout_4.setWidget(38, QtWidgets.QFormLayout.FieldRole, self.edtWandbKey)
        ...
        self.cbxShowGpuInfo.setChecked(False)
        ...
        self.spbParallelSimulations.setProperty("value", 1)
        ...
        self.cbxLocalIterationsType.setCurrentIndex(1)
        self.cbxGradCalculation.setCurrentIndex(0)
        self.cbxDataset.setCurrentIndex(16)
        self.cbxGlobalModel.setCurrentIndex(13)
        ...
        ConfigWidget.setTabOrder(self.edtComRounds, self.cbxClientSamlingType)
        ConfigWidget.setTabOrder(self.cbxClientSamlingType, self.cbxInitializeShiftsPolicy)
        ConfigWidget.setTabOrder(self.cbxInitializeShiftsPolicy, self.edtNumClientsPerRound)
        ConfigWidget.setTabOrder(self.edtNumClientsPerRound, self.edtPoissonSampling)
        ConfigWidget.setTabOrder(self.edtPoissonSampling, self.edtGlbInitLearningRate)
        ...
        ConfigWidget.setTabOrder(self.edtLocalIterations, self.cbxLocalIterationsType)
        ConfigWidget.setTabOrder(self.cbxLocalIterationsType, self.cbxGradCalculation)
        ConfigWidget.setTabOrder(self.cbxGradCalculation, self.edtExperimentalExtraOpts)
        ConfigWidget.setTabOrder(self.edtExperimentalExtraOpts, self.edtLocalWeightDecay)
        ConfigWidget.setTabOrder(self.edtLocalWeightDecay, self.cbxDataset)
        ConfigWidget.setTabOrder(self.cbxDataset, self.cbxSortDatasetByClassBeforeSplit)
        ConfigWidget.setTabOrder(self.cbxSortDatasetByClassBeforeSplit, self.edtMu)
        ConfigWidget.setTabOrder(self.edtMu, self.edtL)
        ConfigWidget.setTabOrder(self.edtL, self.edtSamplesPerClient)
        ConfigWidget.setTabOrder(self.edtSamplesPerClient, self.edtVarsInOpt)
        ConfigWidget.setTabOrder(self.edtVarsInOpt, self.spbHomogeneousDS_L1)
        ConfigWidget.setTabOrder(self.spbHomogeneousDS_L1, self.spbHomogeneousDS_L2)
        ConfigWidget.setTabOrder(self.spbHomogeneousDS_L2, self.edtNumberOfClients)
        ConfigWidget.setTabOrder(self.edtNumberOfClients, self.cbxGlobalModel)
        ConfigWidget.setTabOrder(self.cbxGlobalModel, self.cbxLossFunctionForGlobalModel)
        ConfigWidget.setTabOrder(self.cbxLossFunctionForGlobalModel, self.cbxGlobalLossRegulizer)
        ConfigWidget.setTabOrder(self.cbxGlobalLossRegulizer, self.edtGlobalRegulizerCoefficent)
        ConfigWidget.setTabOrder(self.edtGlobalRegulizerCoefficent, self.cbxValidationOptMetric)
        ConfigWidget.setTabOrder(self.cbxValidationOptMetric, self.edtValidationAssementFreq)
        ConfigWidget.setTabOrder(self.edtValidationAssementFreq, self.btnTrackAll)
        ConfigWidget.setTabOrder(self.btnTrackAll, self.cbxTrackObjectiveFunctionValueTrain)
        ConfigWidget.setTabOrder(self.cbxTrackObjectiveFunctionValueTrain, self.cbxTrackNormFullGradientTrain)
        ConfigWidget.setTabOrder(self.cbxTrackNormFullGradientTrain, self.cbxTrackObjectiveFunctionValueVal)
        ConfigWidget.setTabOrder(self.cbxTrackObjectiveFunctionValueVal, self.cbxTrackNormFullGradientVal)
        ConfigWidget.setTabOrder(self.cbxTrackNormFullGradientVal, self.btnLaunchSimulation)
        ConfigWidget.setTabOrder(self.btnLaunchSimulation, self.edtDataPath)
        ConfigWidget.setTabOrder(self.edtDataPath, self.edtSerializingThreadPool)
        ConfigWidget.setTabOrder(self.edtSerializingThreadPool, self.edtNumWorkersForValDataLoad)
        ConfigWidget.setTabOrder(self.edtNumWorkersForValDataLoad, self.edtNumWorkersForTrainDataLoad)
        ConfigWidget.setTabOrder(self.edtNumWorkersForTrainDataLoad, self.edtLocalTraininThreadPool)
        ConfigWidget.setTabOrder(self.edtLocalTraininThreadPool, self.edtDataLoadBatchSize)
        ConfigWidget.setTabOrder(self.edtDataLoadBatchSize, self.cbxRunDeterministically)
        ...
        ConfigWidget.setTabOrder(self.cbxLoggingLevels, self.edtCheckpointDir)
        ConfigWidget.setTabOrder(self.edtCheckpointDir, self.edtEvalThreadPool)
        ConfigWidget.setTabOrder(self.edtEvalThreadPool, self.edtJobId)
        ConfigWidget.setTabOrder(self.edtJobId, self.cbxLogGPUusage)
        ConfigWidget.setTabOrder(self.cbxLogGPUusage, self.cbxAllowUseNvTensorCores)
        ConfigWidget.setTabOrder(self.cbxAllowUseNvTensorCores, self.btnGenerateInitSeed)
        ConfigWidget.setTabOrder(self.btnGenerateInitSeed, self.cbxGenerateInitSeedAuto)
        ConfigWidget.setTabOrder(self.cbxGenerateInitSeedAuto, self.edtRandomInitSeed)
        ConfigWidget.setTabOrder(self.edtRandomInitSeed, self.btnGenerateRunSeed)
        ConfigWidget.setTabOrder(self.btnGenerateRunSeed, self.cbxGenerateRunSeedAuto)
        ConfigWidget.setTabOrder(self.cbxGenerateRunSeedAuto, self.edtRandomRunSeed)
        ConfigWidget.setTabOrder(self.edtRandomRunSeed, self.edtGroupName)
        ConfigWidget.setTabOrder(self.edtGroupName, self.edtCommentForExperiment)
        ConfigWidget.setTabOrder(self.edtCommentForExperiment, self.btnSelectAllGpus)
        ConfigWidget.setTabOrder(self.btnSelectAllGpus, self.edtLoggingFilter)
        ConfigWidget.setTabOrder(self.edtLoggingFilter, self.cbxStoreClientStateInCPU)
        ConfigWidget.setTabOrder(self.cbxStoreClientStateInCPU, self.cbxEmptyGPUTorchCache)
        ConfigWidget.setTabOrder(self.cbxEmptyGPUTorchCache, self.edtWandbKey)
        ConfigWidget.setTabOrder(self.edtWandbKey, self.cbxShowCpuInfo)
        ConfigWidget.setTabOrder(self.cbxShowCpuInfo, self.cbxShowGpuInfo)
        ConfigWidget.setTabOrder(self.cbxShowGpuInfo, self.cbxShowNumberOfWorks)
        ConfigWidget.setTabOrder(self.cbxShowNumberOfWorks, self.spbParallelSimulations)
        ConfigWidget.setTabOrder(self.spbParallelSimulations, self.cbxLoadNameMangling)
        ConfigWidget.setTabOrder(self.cbxLoadNameMangling, self.edtLogFile)
    ...
    def retranslateUi(self, ConfigWidget):
        ...
        self.cbxClientSamlingType.setItemText(3, _translate("ConfigWidget", "Important sampling with replacement"))
        self.cbxClientSamlingType.setItemText(4, _translate("ConfigWidget", "Uniform sampling with replacement"))
        ...
        self.edtNumClientsPerRound.setText(_translate("ConfigWidget", "1"))
        ...
        self.edtLocalInitialLr.setText(_translate("ConfigWidget", "1.0"))
        ...
        self.cbxClientCompressor.setItemText(10, _translate("ConfigWidget", "Perm-K"))
        ...
        self.cbxGradCalculation.setItemText(0, _translate("ConfigWidget", "sgd-nice, tau:1 local.samples (no repeat)"))
        self.cbxGradCalculation.setItemText(1, _translate("ConfigWidget", "sgd-multi, tau:1 local.samples (with repeat)"))
        self.cbxGradCalculation.setItemText(2, _translate("ConfigWidget", "sgd-ind, tau:1 local.samples (cardinality is random)"))
        self.cbxGradCalculation.setItemText(3, _translate("ConfigWidget", "sgd-nice, tau:2% local.samples (no repeat)"))
        self.cbxGradCalculation.setItemText(4, _translate("ConfigWidget", "sgd-nice, tau:10% local.samples"))
        self.cbxGradCalculation.setItemText(5, _translate("ConfigWidget", "sgd-nice, tau:20% local.samples"))
        ...
        self.cbxGradCalculation.setItemText(24, _translate("ConfigWidget", "sgd-ind, tau:10% local.samples (cardinality is random)"))
        self.cbxGradCalculation.setItemText(25, _translate("ConfigWidget", "sgd-ind, tau:20% local.samples"))
        self.cbxGradCalculation.setItemText(26, _translate("ConfigWidget", "sgd-ind, tau:30% local.samples"))
        self.cbxGradCalculation.setItemText(27, _translate("ConfigWidget", "sgd-ind, tau:40% local.samples"))
        self.cbxGradCalculation.setItemText(28, _translate("ConfigWidget", "sgd-ind, tau:50% local.samples"))
        self.cbxGradCalculation.setItemText(29, _translate("ConfigWidget", "sgd-ind, tau:60% local.samples"))
        self.cbxGradCalculation.setItemText(30, _translate("ConfigWidget", "sgd-ind, tau:80% local.samples"))
        self.cbxGradCalculation.setItemText(31, _translate("ConfigWidget", "sgd-ind, tau:90% local.samples"))
        self.cbxGradCalculation.setItemText(32, _translate("ConfigWidget", "sgd-ind, tau:100% local.samples"))
        ...
        self.edtExperimentalExtraOpts.setText(_translate("ConfigWidget", "th_stepsize_noncvx;use_optimal_p;page_ab_synthetic;logregression"))
        ...
        self.cbxDataset.setItemText(30, _translate("ConfigWidget", "Splice"))
        self.cbxDataset.setItemText(31, _translate("ConfigWidget", "Australian"))
        ...
        self.edtL.setText(_translate("ConfigWidget", "12.0"))
        self.lblSamplesPerClient.setText(_translate("ConfigWidget", "Number of samples per client"))
        self.edtSamplesPerClient.setText(_translate("ConfigWidget", "100"))
        ...
        self.lblHomogeneousDS_L1.setText(_translate("ConfigWidget", "Homogeneous datasets Level-1"))
        ...
        self.cbxGlobalModel.setItemText(0, _translate("ConfigWidget", "resnet18"))
        self.cbxGlobalModel.setItemText(1, _translate("ConfigWidget", "resnet34"))
        self.cbxGlobalModel.setItemText(2, _translate("ConfigWidget", "resnet50"))
        self.cbxGlobalModel.setItemText(3, _translate("ConfigWidget", "resnet101"))
        self.cbxGlobalModel.setItemText(4, _translate("ConfigWidget", "resnet152"))
        self.cbxGlobalModel.setItemText(5, _translate("ConfigWidget", "vgg11"))
        self.cbxGlobalModel.setItemText(6, _translate("ConfigWidget", "vgg13"))
        self.cbxGlobalModel.setItemText(7, _translate("ConfigWidget", "vgg16"))
        self.cbxGlobalModel.setItemText(8, _translate("ConfigWidget", "vgg19"))
        self.cbxGlobalModel.setItemText(9, _translate("ConfigWidget", "Wideresnet282"))
        self.cbxGlobalModel.setItemText(10, _translate("ConfigWidget", "Wideresnet284"))
        self.cbxGlobalModel.setItemText(11, _translate("ConfigWidget", "Wideresnet288"))
        self.cbxGlobalModel.setItemText(12, _translate("ConfigWidget", "linear"))
        self.cbxGlobalModel.setItemText(13, _translate("ConfigWidget", "logistic"))
        ...
        self.lblHomogeneousDS_L2.setText(_translate("ConfigWidget", "Homogeneous datasets Level-2"))
        self.lblSolutionPerturbation.setText(_translate("ConfigWidget", "Perturbation of solution scale"))
        self.edtSolPerturbation.setText(_translate("ConfigWidget", "100.0"))
        ...
        self.edtGroupName.setText(_translate("ConfigWidget", "{algorithm}-{algorithm-options}"))
