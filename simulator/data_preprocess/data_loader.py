...
def load_data(exec_ctx, path, dataset, args, load_trainset=True, download=True, client_id=None):
    ...
    if dataset.startswith("cifar"):  # CIFAR-10/100
        ...
        trainset.compute_Li_data_sample_for_linear_regression(args)
        testset.compute_Li_data_sample_for_linear_regression(args)
        ...
        trainset.compute_Li_data_sample_for_logregression()
        #testset.compute_Li_data_sample_for_logregression()
...
def get_num_classes(dataset):
    ...
    if dataset in ['cifar10', 'cifar10_fl', 'cifar10_fl_by_class']:
        ...
        num_classes = 2
    elif dataset in ['mushrooms', 'phishing', 'australian', 'splice']:
        num_classes = 2
    else:
...
def get_num_clients(dataset):
    ...
    if dataset in ['emnist', 'cifar10', 'cifar100', 'full_shakespeare']:
        ...
        num_clients = kClients
    elif dataset == 'australian' or dataset == 'splice':
        num_clients = kClients
    else:
        raise ValueError(f"Dataset {dataset} is not supported.")
